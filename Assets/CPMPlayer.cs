/*  QUAKE LIKE MOVEMENT
 *  Ensure that you have a character Controller on the same object, and that you also set the inputs and the player view (Camera)
 * 
 * - Edited by Stuart (1/18/2020)
 *   ----------------------------
 *   Refactoring magic strings for easy editing
 *  
 * - Found here : https://github.com/WiggleWizard/quake3-movement-unity3d
 * 
...
public class CPMPlayer : MonoBehaviour
{
    ...
    public string fire1 = "Fire1"; // For locking the coursor to the screen
    public string VerticalMovement = "Vertical";
    public string HorizontalMovement = "Horizontal";
    public string JumpButton = "Jump";
    public float xMouseSensitivity = 10.0f;
    public float yMouseSensitivity = 10.0f;
    [Space(10)]
    ...
    private void Update()
    {
        ...
        rotX -= Input.GetAxisRaw(mouseY) * xMouseSensitivity * 0.02f;
        rotY += Input.GetAxisRaw(mouseX) * yMouseSensitivity * 0.02f;
   ...
   \*******************************************************************************************************/
    ...
    {
        _cmd.forwardMove = Input.GetAxisRaw(VerticalMovement);
        _cmd.rightMove = Input.GetAxisRaw(HorizontalMovement);
    }
    ...
    private void QueueJump()
    {
        if (holdJumpToBhop)
        {
            wishJump = Input.GetButton(JumpButton);
            return;
        }
